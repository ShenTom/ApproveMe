    ...
    return(
      <div className="login-page">
        <div className="login-container">
          <p onClick={()=>{console.log(this.props)}}className="login-header">Sign into ApproveMe</p>
          <p className="sub-header">Login with your Slack account to view and manage your teams requests.</p>
          <a href={url}><img alt="Sign in with Slack" height="40" width="172" src="https://platform.slack-edge.com/img/sign_in_with_slack.png" /></a>
